...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public GamePanel() {
        ...
        jButton.setBounds(310, 240, 100, 40);
        add(jButton);
        resetGame();
    }
    ...
    public void drawUI(Graphics page) {
        ...
        // DRAW score X
        ImageIcon xIcon = new ImageIcon("xImage.png");
...
//         	page.drawImage(logo, 325, 215, 70,50, this);
//         	Font c = new Font("Courier", Font.BOLD + Font.CENTER_BASELINE, 13);
//         	page.setFont(c);
//         	page.drawString("Have fun!!", 320, 285);
    }
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                try {
                    ...
                    pw.write("0\n"); // Reset player 1 wins to 0
                    pw.write("0\n"); // Reset player 2 wins to 0
                    pw.close();
